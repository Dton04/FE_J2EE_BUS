        ...
        <div className="flex border-b border-gray-100">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex-1 py-3.5 flex items-center justify-center gap-2 text-sm font-semibold transition relative ${activeTab === tab.id
          ...
          <div className="flex flex-col xl:flex-row items-stretch gap-2">
            ...
            <div ref={dateRowRef} className="flex gap-2 xl:flex-none">
              ...
              <button
                ...
                className={`flex items-center gap-2.5 px-4 py-3 border rounded-xl min-w-[170px] transition ${pickerOpen && pickerMode === 'depart'
              ...
              <button
                ...
                className={`flex items-center gap-2.5 px-4 py-3 border rounded-xl min-w-[170px] transition relative ${returnDate
            ...
            <button
              onClick={() => {
                ...
                const params = new URLSearchParams({
                  from,
                  to,
                  date: departDate ? formatYYYYMMDD(departDate) : '',
                });
                if (fromId) params.append('fromId', fromId.toString());
                if (toId) params.append('toId', toId.toString());
                if (returnDate) params.append('returnDate', formatYYYYMMDD(returnDate));
